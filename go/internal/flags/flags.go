...
var Specs = []Spec{
        ...
        {"lottery.auto_slot", "lottery", "auto_slot", "老虎机", "lottery", "high", "高波动，默认关；无 RTP 证明仍不会盲转"},
        {"lottery.auto_yolo", "lottery", "auto_yolo", "搏一搏", "lottery", "high", "页面「搏一搏」/全额下注，高波动默认关"},
        {"lottery.auto_nailong", "lottery", "auto_nailong", "奶龙机", "lottery", "high", "高波动玩法，默认关"},
        {"lottery.auto_vip", "lottery", "auto_vip", "自动进VIP", "lottery", "high", "余额达门槛才可进房"},
        {"lottery.auto_vip_bet", "lottery", "auto_vip_bet", "VIP自动下注", "lottery", "high", "进房后自动下注，风险更高"},
        {"lottery.auto_borrow_zero_rate", "lottery", "auto_borrow_zero_rate", "自动借零息", "lottery", "mid", "仅零息挂单；默认扫描不借"},
        ...
        {"derivatives.trade_enabled", "derivatives", "trade_enabled", "期货实盘下单", "derivatives", "high", "关闭时仅分析/计划，不落保证金单"},
        {"brokers.auto_like", "brokers", "auto_like", "券商自动点赞", "brokers", "low", "点赞热门券商"},
        {"brokers.auto_underwrite", "brokers", "auto_underwrite", "自动承销", "brokers", "high", "高门槛，默认关"},
}
